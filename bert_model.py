...
class BertEmbeddings(nn.Module):
    ...
    def forward(self, input_ids, token_type_ids=None):
        seq_length = input_ids.size(1)  # max_seq_length
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, output_all_encoded_layers=True):
        ...
        # print("encoded_layers的size：", encoded_layers[0].size())  # torch.Size([6, 128, 768])
...
class BertForNgramClassification(BertPreTrainedModel):
    ...
    def forward(self, ngram_ids, attention_mask=None, ngram_embeddings=None):
